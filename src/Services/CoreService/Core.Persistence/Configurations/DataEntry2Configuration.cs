...
public sealed class DataEntry2Configuration : IEntityTypeConfiguration<InvestmentCaseAttractionBasis>
{
    public void Configure(EntityTypeBuilder<InvestmentCaseAttractionBasis> builder)
    {
