...
public sealed class CaseValuationConfiguration : IEntityTypeConfiguration<InvestmentCaseValuation>
{
    public void Configure(EntityTypeBuilder<InvestmentCaseValuation> builder)
    {
