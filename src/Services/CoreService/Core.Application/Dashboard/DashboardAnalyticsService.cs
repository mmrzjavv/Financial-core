    ...
    ILogger<DashboardAnalyticsService> logger) : IDashboardAnalyticsService
{
    ...
    public async Task<Result<RoleDashboardResponse>> GetMyDashboardAsync(CancellationToken cancellationToken = default)
    {
        ...
        var result = viewKind switch
        {
            ...
            DashboardViewKind.Department => await BuildDepartmentResponseAsync(cancellationToken),
    ...
    public async Task<Result<DepartmentDashboardViewDto>> GetDepartmentDashboardAsync(CancellationToken cancellationToken = default)
    {
        var response = await BuildDepartmentResponseAsync(cancellationToken);
    ...
    private async Task<Result<RoleDashboardResponse>> BuildDepartmentResponseAsync(CancellationToken ct)
    {
        var departmentKey = DashboardRoleResolver.ResolveDepartmentKey(userContext.Roles);
        ...
        var snapshotKey = DashboardRoleResolver.DepartmentSnapshotKey(departmentKey);
        ...
        var inboxLinks = await LoadInboxQuickLinksAsync(ct);
