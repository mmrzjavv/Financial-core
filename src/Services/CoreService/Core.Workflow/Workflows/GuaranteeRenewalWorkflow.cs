...
public sealed class GuaranteeRenewalWorkflow : WorkflowBase
{
    public const string DefinitionId = $"{nameof(Core)}.{nameof(Workflow)}.{nameof(Workflows)}.{nameof(GuaranteeRenewalWorkflow)}";
    ...
    protected override void Build(IWorkflowBuilder builder)
    {
        ...
        var start = new WriteLine("Guarantee renewal workflow started") { Id = "Start" };
        ...
        var end = new WriteLine("Guarantee renewal workflow completed") { Id = "End" };
