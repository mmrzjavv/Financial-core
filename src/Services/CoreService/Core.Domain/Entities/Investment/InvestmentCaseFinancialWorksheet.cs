...
public sealed class InvestmentCaseFinancialWorksheet : Entity<Guid>, IAuditableEntity
{
    private InvestmentCaseFinancialWorksheet()
    {
        BankName = default!;
        Iban = default!;
    ...
    public InvestmentCaseFinancialWorksheet(
        Guid caseId,
        string bankName,
        string iban,
