...
public sealed class InvestmentCaseWorkflowHistory : Entity<Guid>, IAuditableEntity
{
    private InvestmentCaseWorkflowHistory()
    {
    ...
    public InvestmentCaseWorkflowHistory(
        Guid caseId,
        CasePhase fromPhase,
        CasePhase toPhase,
