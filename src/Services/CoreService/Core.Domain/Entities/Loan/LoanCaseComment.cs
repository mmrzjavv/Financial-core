...
public sealed class LoanCaseComment : Entity<Guid>, IAuditableEntity
{
    private LoanCaseComment()
    {
        SenderUserId = default!;
        Message = default!;
    }

    public LoanCaseComment(
        Guid caseId,
        LoanCasePhase phase,
        string senderUserId,
        string? senderRole,
    ...
    public LoanCasePhase Phase { get; private set; }
